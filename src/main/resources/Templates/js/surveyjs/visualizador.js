        ...
        encuestas.forEach(encuesta => {
            tableHTML += `
                <tr>
                    ...
                    <td><button onclick="verCapitulos(${encuesta.id})">Ver Capítulos</button></td>
                </tr>
            `;
        });
...
function verCapitulos(encuestaId) {
    // Redirige a una página con los capítulos de la encuesta
    window.location.href = `verCapitulos.html?surveyId=${encuestaId}`;
}